...
def is_callable_decl_constructor(decls: Declarations, decl: CallableDecl) -> bool:
    ...
    match decl:
        ...
        case ConstantDecl() as const_decl:
            return (
                not decls.get_class_decl(const_decl.type_ref.ident).builtin
                and const_decl.body is None
                and const_decl.merge is None
            )
        case _:
            assert_never(decl)
...
RuleEvalMode: TypeAlias = Literal["seminaive", "naive", "unsafe-seminaive"]
