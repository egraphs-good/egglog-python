    ...
    {
        {
                        ...
                        polynomial(
                            {
                                ...
                                {Num.var("x0"): 1}: -3.3628776435387486,
                                {
                                    Num.var("x0"): 1,
                                    polynomial(
                                        {{}: 0.065716650770683, {Num.var("x1"): 1}: -1.096491354684671, {exp(Num.var("x1")): 1}: 0.09649135468467125, {Num.var("x0"): 1}: 1.0}
                                    ): 1,
                                }: 1.1635766746115828,
                            }
                        ): 1,
            ...
            polynomial({{}: 3.3628776435387486, {Num.var("x1"): 1}: -1.0, {exp(Num.var("x1")): 1}: 1.0, {exp(polynomial({{Num.var("x0"): 2}: 1.0})): 1}: 1.0}): -1,
        }: 1.0
    }
)
            ...
            polynomial(
                {
                    ...
                    {
                        Num.var("x0"): 1,
                        polynomial({{}: -2.824404573652556, {Num.var("x1"): 1}: -1.096491354684671, {Num.var("x0"): 1}: 1.0, {exp(Num.var("x1")): 1}: 0.09649135468467127}): 1,
                    }: 1.0,
                }
            ): 1,
            polynomial({{}: 3.3628776435387486, {Num.var("x1"): 1}: -1.0, {exp(Num.var("x1")): 1}: 1.0, {exp(polynomial({{Num.var("x0"): 2}: 1.0})): 1}: 1.0}): -1,
