...
@final
class Program:
    def __new__(cls, *commands: _Command) -> Program: ...
    @staticmethod
    def parse(source: str, /, filename: str | None = None) -> Program: ...
    @staticmethod
    def from_json(json: str) -> Program: ...
    @staticmethod
    def json_schema() -> str: ...
    def to_json(self) -> str: ...
    def to_egglog(self) -> str: ...
    def to_replayable_egglog(self) -> str: ...
...
class EGraph:
    ...
    def stop_recording(self) -> CommandRecord | None: ...
    def recorded_program(self) -> Program | None: ...
    def run_shared_program(
        self, program: Program, /, *, traceparent: str | None = None, tracestate: str | None = None
    ) -> list[_CommandOutput]: ...
